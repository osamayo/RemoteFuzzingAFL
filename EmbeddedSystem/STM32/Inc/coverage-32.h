...
//  mem16[1] = count_class_lookup16[mem16[1]];
  ...
  u8 b1= mem16[0] >> 8;
  u8 b2= mem16[0] & 0xff;
  mem16[0] = (count_class_lookup8[b1] << 8) | count_class_lookup8[b2];
  b1= mem16[1] >> 8;
  b2= mem16[1] & 0xff;
  mem16[1] = (count_class_lookup8[b1] << 8) | count_class_lookup8[b2];
  memcpy(&word, mem16, sizeof(mem16));
  return word;

}

#ifndef IGNORE_SIMPLIFY_TRACE
